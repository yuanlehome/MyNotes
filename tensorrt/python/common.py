...
TRT_LOGGER_INFO = trt.Logger(trt.Logger.INFO)
TRT_LOGGER_WARNING = trt.Logger(trt.Logger.WARNING)
TRT_LOGGER_VERBOSE = trt.Logger(trt.Logger.VERBOSE)
...
def allocate_buffers(engine):
    ...
    for binding in engine:
        ...
        device_mem = cuda.mem_alloc(host_mem.nbytes + 1)
